...
export const SecondStep: React.FC<{ handleBackStep: () => void }> = ({ handleBackStep }) => {
        ...
        <Box display='flex' height='100vh' width='100%' flexDirection='row'>
            <Box display='flex' paddingLeft='1.5em' gap="1em" bgcolor='#F9F9F9' height="100%" width="55%" flexDirection='column'>
                ...
                <Box display='flex' paddingLeft='7.5em' width='88%' flexDirection='row' justifyContent='space-between' paddingTop='4em'>
                    ...
                    <Button sx={{ bgcolor: '#6B40E3', width: '151px', height: '48px', borderRadius: '4px', color: 'white', fontSize: '18px',fontWeight:'500' }}>შემდეგი</Button>
                </Box>
            </Box>
            <Resume></Resume>
        </Box>
...
const WizardForm: React.FC = () => {
    ...
    const renderStep = (step: number) => {
        switch (step) {
            ...
            case 2:
                return <SecondStep handleBackStep={handleBackStep} />
            case 3:
                return <ThirdStep />
            default:
                return null
